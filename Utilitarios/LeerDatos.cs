...
namespace Utilitarios
{
    public class LeerDatos
    {
        ...
        public bool Es_Email(Control miTextBox)
        {
            ...
            return regex.IsMatch(miTextBox.Text.ToString().ToLower());
        }
